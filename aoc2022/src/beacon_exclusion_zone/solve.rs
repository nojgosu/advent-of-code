...
pub fn solve_first_star() -> usize {
    let sensors = parse_input("src/beacon_exclusion_zone/input.txt");

    let y = 2_000_000;

    count_impossible_positions(sensors, y)
}
...
pub fn solve_second_star() -> usize {
    ...
    for y in y_range {
        ...
        if range.len() > 1 {
            ...
            println!("y = {:?}, contender = {:?}", y, range);
        }
    }

    // y = 2973564 ;  x = 3244277

    // TODO: identify why the other contenders should be ruled out
